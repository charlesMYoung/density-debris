				...
				return {
					md: {
						...
						css: {
							...
							'--tw-prose-quote-borders': 'var(--md-sys-color-primary-container)',
							...
							'--tw-prose-invert-counters': 'var(--md-sys-color-primary-container)',
							'--tw-prose-invert-bullets': 'var(--md-sys-color-secondary)',
							'--tw-prose-invert-hr': 'var(--md-sys-color-primary)',
							'--tw-prose-invert-quotes': 'var(--md-sys-color-primary-container)',
							'--tw-prose-invert-quote-borders': 'var(--md-sys-color-primary)',
							'--tw-prose-invert-captions': 'var(--md-sys-color-primary-container)',
							'--tw-prose-invert-code': theme('colors.white'),
							'--tw-prose-invert-pre-code': 'var(--md-sys-color-primary-container)',
